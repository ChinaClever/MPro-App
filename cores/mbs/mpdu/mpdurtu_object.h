#ifndef MPDURTU_OBJECT_H
#define MPDURTU_OBJECT_H

#include "mpdurtu_regs.h"

class Mpdurtu_Object : public Modbus_SlaveRtu , public Set_Output
{
public:
    explicit Mpdurtu_Object(QObject *parent = nullptr);
