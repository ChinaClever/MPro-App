...
bool Web_Obj::setCfg(uint type, uint fc, const QVariant &value, uint addr, uint id)
{
    sCfgItem it; it.txType = DTxType::TxWeb; it.id = id;
...
{
    sCfgItem it; it.addr = addr; it.type = type; it.fc = fc; it.id = sub;
