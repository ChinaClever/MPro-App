...
public slots:
    ...
    Q_INVOKABLE bool pduCfgSet(uchar type, uchar fc, const QVariant &value, uchar addr=0, uchar id=0);
    Q_INVOKABLE QString pduCfgGet(uchar type, uchar fc, uchar addr=0, uchar id=0);
