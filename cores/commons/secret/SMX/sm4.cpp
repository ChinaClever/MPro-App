...
void Sm4::setKey(const QByteArray &k) {
    key = k;
}

void Sm4::setIv(const QByteArray &i) {
    iv = i;
}
...
QByteArray Sm4::encrypt(const QByteArray &data) {
...
QByteArray Sm4::decrypt(const QByteArray &data) {
